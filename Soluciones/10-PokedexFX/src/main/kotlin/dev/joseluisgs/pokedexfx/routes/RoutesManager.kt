package dev.joseluisgs.pokedexfx.routes
...
object RoutesManager {
    ...
    fun initMainStage(stage: Stage) {
        ...
        val mainScene = Scene(parentRoot, 680.0, 440.0)

        stage.apply {
            title = "Pokedex"
            isResizable = false
            icons.add(Image(getResourceAsStream("icons/pokedex.png")))
            scene = mainScene
            mainStage = stage
            _activeStage = stage
